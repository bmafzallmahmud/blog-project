...
<link href="{{asset('fontEnd/css/single-post/styles.css')}}" rel="stylesheet">

<link href="{{asset('fontEnd/css/single-post/responsive.css')}}" rel="stylesheet">
<style>
.header-bg{
    height: 400px;
    width: 100%;
               ...
               <div class="col-lg-4 col-md-6">
                   <div class="card h-100">
                       <div class="single-post post-style-1">
                           ...
                           <a class="avatar" href="#"><img src="{{ Storage::disk('public')->url('profile/'.$randompost->user->image) }}" alt="{{ $randompost->title }}"></a>
